...
Source: [http://xplproject.org.uk/wiki/index.php?title=XPL_Specification_Document#Heartbeat_Messages|XPL heartbeat specifications]
XPL Hbeat: [http://xplproject.org.uk/wiki/index.php?title=Schema_-_HBEAT|HBEAT Schema] 
Evolution: [http://tracker.domogik.org/issues/728|728 (hbeat discovery)]
Evolution: [http://tracker.domogik.org/issues/717|717 (hbeat.end)]
