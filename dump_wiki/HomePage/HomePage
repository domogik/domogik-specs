...
Domogik is multi hosts and modulable. You can use as many user interfaces you want (actually there are two user interfaces : the web one and the `Android <https://market.android.com/details?id=org.panel&amp;feature=search\_result>`_ one). 
<br /><br /><br />
...
* `Domoweb installation (the same for production and development) <http://docs.domogik.org/domoweb/dev/en/installation/index.html>`_
...
* `How to develop a plugin or an external member <http://docs.domogik.org/domogik/dev/en/package\_development/index.html>`_
* `Usefull tools <http://docs.domogik.org/domogik/dev/en/tools/index.html>`_
* `Code generated documentation <http://api.domogik.org/>`_
