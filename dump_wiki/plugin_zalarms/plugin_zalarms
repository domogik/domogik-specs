...
!!Prerequisites
Install the [http://wiki.domogik.org/plugin_zalarms|cron] plugin and start it.
...
The jobs you have created are now stored (permanently) in the cron plugin store. If you want to delete them, look at the [http://wiki.domogik.org/plugin_zalarms|cron] plugin.
...
The last thing to do is to add widgets. Look at the [http://wiki.domogik.org/plugin_zalarms|cron] documentation.