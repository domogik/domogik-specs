...
! General info
[http://www.velbus.eu|Velbus] is a protocol from [http://www.vellman.eu|Velleman].
...
[http://www.velleman.be/downloads/Velbus_ProtocolSummary.pdf|Velbus Protocol Summary]
