...
.. code-block::
    deb http://bibi21000.gallet.info/ubuntu oneiric universe{CODE}
    For Precise (i386 and amd64, armel will come soon) :
.. code-block::
    deb http://bibi21000.gallet.info/ubuntu precise universe{CODE}

Get the gpg keys to authenticate packages.
.. code-block::
    wget -O - http://bibi21000.gallet.info/ubuntu/maintainers.keys | sudo apt-key add -{CODE}
...
.. code-block::
    #sudo apt-get purge xplhub domoweb domogik-full domogik-primary domogik-secondary domogik-mysql domogik-postgresql domogik-common{CODE}
...
.. code-block::
    #sudo apt-get install domogik-full{CODE}
    Primary server
    ***************
    If you want to install a primary server, install this package :
.. code-block::
    #sudo apt-get install domogik-primary{CODE}
Secondary server
*****************
If you want to install a secondary server, install this package :
.. code-block::
    #sudo apt-get install domogik-secondary{CODE}
...
.. code-block::
    #sudo apt-get install domogik-primary domogik-postgresql{CODE}PS : Not tested. If you want to use it, contact-me on IRC, Forum or Developpers Mailing List (preferred)
...
.. code-block::
    #apt-get install domoweb{CODE}
    Using apache with domoweb
    **************************
.. code-block::
    #sudo apt-get install domoweb-apache2{CODE}PS : Not tested. If you want to use it, contact-me on IRC, Forum or Developpers Mailing List (preferred)

Developpers
============
Installing a package repository for ubuntu : `http://wiki.domogik.org/ubuntu\_repository|nocache <http://wiki.domogik.org/ubuntu\_repository>`_